...
| PR10 | Fiches clientes en double détectées et fusionnables (la fusion ne fait que repointer `client_id`, hors signature), historique d'achats consultable en caisse (« déjà venue 3 fois, dont la semaine dernière »), suppression RGPD différée de 30 jours et annulable (cron quotidien à 04:00) | **en cours (cette PR)** |
